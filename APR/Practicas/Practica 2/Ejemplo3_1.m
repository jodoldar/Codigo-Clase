...
K1 = cell(3,1); K2=K1; K1{1}=1; K2{1} = 2;
NM=75;
for i=1:NM
...
figure
subplot(2,1,1);
etiqApr=load('./data/gaus2D/gauss2Dtr.labels','-ascii');
plot(datosApr(etiqApr==1,1),datosApr(etiqApr==1,2), 'x');
plot(datosApr(etiqApr==2,1),datosApr(etiqApr==2,2), 'o');
plot(datosApr(etiqApr==1,1),datosApr(etiqApr==1,2), 'x', datosApr(etiqApr==2,1),datosApr(etiqApr==2,2),'o');
axis([-4 5 -4 4])
subplot(2,1,2);
plot(muestras(1:NM,1),muestras(1:NM,2),'x',muestras(NM:2*NM,1),muestras(NM:2*NM,2),'o');
axis([-4 5 -4 4])
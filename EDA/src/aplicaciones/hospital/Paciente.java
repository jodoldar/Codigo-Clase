...
public class Paciente implements Comparable<Paciente>  {
   ...
   /**
    ...
    public int compareTo(Paciente otro) { 
        int res = 0; 
        /*if(otro.getEstado() > this.estado){
            res = -1;
        }else if(otro.getEstado() < this.estado){
            res = 1;
        }else if(otro.getEdad() < 15 || this.getEdad() < 15){
            res = this.getEdad()-otro.getEdad();
        }else if(otro.getEdad() > 65 || this.getEdad() > 65){
            res = otro.getEdad()-this.getEdad();
        }*/
        if(this.getEstado()!=otro.getEstado()){
            return this.getEstado() - otro.getEstado();
        }else if(this.getEdad()<15 || otro.getEdad()<15){
            return this.getEdad() - otro.getEdad();
        }else if(this.getEdad()>65 || otro.getEdad()>65){
            return otro.getEdad() - this.getEdad();
        }
        return res;
    }

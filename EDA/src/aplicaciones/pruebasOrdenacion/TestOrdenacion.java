...
/** 
 *  La clase TestOrdenacion permite probar y temporizar los metodos 
 *  de ordenacion de arrays genericos definidos en la clase 
...
public class TestOrdenacion {
    ...
    public static void comprobar() {
        ...
        if(Ordenacion.sonIguales(a1,a2)){
            System.out.println("Los vectores se ordenan bien");
        }else{
            System.out.println("Hay un fallo en la ordenación de los vectores");
        }
        
        // A completar: prueba de que mergeSort2 ordena correctamente        
    }
    ...
    public static void temporizar() {
        ...
        for (int k = INI; k <= FI; k = k + INC) {
            int talla = k;
            t1 = t2 = tacum1 = tacum2 = tacum3 = tacum4 = 0;
            for (int i = 1; i <= numRep; i++) {
                ...
                //  A completar: Temporizacion de mergeSort2
                t1 = System.nanoTime();
            ...
            System.out.printf(Locale.US, "%1$8d %2$12.4f %3$12.4f %4$12.4f %5$12.4f\n",
                      talla, 
                      tacum1 / numRep / 1e6, 
                      tacum2 / numRep / 1e6,
                      tacum3 / numRep / 1e6,
    ...
    /**
     * Devuelve un array de elementos Integer generados aleatoriamente

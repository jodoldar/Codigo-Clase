...
public class ABB<E extends Comparable<E>> {
    ...
    protected NodoABB<E> construirEquilibrado(E[] v, int ini, int fin) {
        ...
        NodoABB aux;
        if(ini<fin){
            return aux = new NodoABB(v[mediana],construirEquilibrado(v, ini, mediana-1),construirEquilibrado(v, mediana+1, fin));
        }else{
            return null;
        }
    }
    ...
    public void reconstruirEquilibrado() {
       ...
       this.raiz = construirEquilibrado(aux,0,aux.length-1);
    }
